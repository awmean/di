...
def admin_home(
    request: Request, session=Depends(require_auth), db: Session = Depends(get_db)
):
...
def admin_products(
    ...
    return templates.TemplateResponse(
        "products.html", {"request": request, "user": user, "products": products}
    )
...
def admin_categories(
    ...
    categories = CategoryRepository.get_all(db)
    return templates.TemplateResponse(
        "categories.html", {"request": request, "user": user, "categories": categories}
    )
